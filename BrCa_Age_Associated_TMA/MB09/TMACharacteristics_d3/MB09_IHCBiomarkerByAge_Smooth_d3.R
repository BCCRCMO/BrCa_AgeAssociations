...
### TNP and luminal
tnmadf <- tmadf[tmadf$BrCa4 == "TNP", ]
lpmadf <- tmadf[tmadf$BrCa4 == "Luminalp", ]

date()
pdf(file = "MB09_TNP_IHC_Trends_95pct_2kSimCIs_shaded_v01.pdf", width = 8, height = 8)
par(mfrow = c(2, 2))
sapply(cscvars, simsmufit, xdf = tnmadf, nsim = 2000, alpha = 0.05)
dev.off()
date()
date()
pdf(file = "MB09_TNP_IHC_Trends_99pct_10kSimCIs_shaded_v01.pdf", width = 8, height = 8)
par(mfrow = c(2, 2))
sapply(cscvars, simsmufit, xdf = tnmadf, nsim = 10000, alpha = 0.01)
dev.off()
date()
date()
pdf(file = "MB09_TNP_IHC_Trends_99p9pct_40kSimCIs_shaded_v01.pdf", width = 8, height = 8)
par(mfrow = c(2, 2))
sapply(cscvars, simsmufit, xdf = tnmadf, nsim = 40000, alpha = 0.001)
dev.off()
date()
date()
pdf(file = "MB09_TNP_IHC_Trends_99p99pct_400kSimCIs_shaded_v01.pdf", width = 8, height = 8)
par(mfrow = c(2, 2))
sapply(cscvars, simsmufit, xdf = tnmadf, nsim = 400000, alpha = 0.0001)
dev.off()
date()

date()
pdf(file = "MB09_Luminalp_IHC_Trends_95pct_2kSimCIs_shaded_v01.pdf", width = 8, height = 8)
par(mfrow = c(2, 2))
sapply(cscvars, simsmufit, xdf = lpmadf, nsim = 2000, alpha = 0.05)
dev.off()
date()
date()
pdf(file = "MB09_Luminalp_IHC_Trends_99pct_10kSimCIs_shaded_v01.pdf", width = 8, height = 8)
par(mfrow = c(2, 2))
sapply(cscvars, simsmufit, xdf = lpmadf, nsim = 10000, alpha = 0.01)
dev.off()
date()
date()
pdf(file = "MB09_Luminalp_IHC_Trends_99p9pct_40kSimCIs_shaded_v01.pdf", width = 8, height = 8)
par(mfrow = c(2, 2))
sapply(cscvars, simsmufit, xdf = lpmadf, nsim = 40000, alpha = 0.001)
dev.off()
date()
date()
pdf(file = "MB09_Luminalp_IHC_Trends_99p99pct_400kSimCIs_shaded_v01.pdf", width = 8, height = 8)
par(mfrow = c(2, 2))
sapply(cscvars, simsmufit, xdf = lpmadf, nsim = 400000, alpha = 0.0001)
dev.off()
date()
