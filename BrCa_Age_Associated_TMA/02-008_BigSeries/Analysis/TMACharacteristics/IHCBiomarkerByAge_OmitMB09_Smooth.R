...
write.csv(tmadf, file = "../BuildData/02-008_BigSeries_NoMB09_NoMBex_Training.CSV")
write.csv(vmadf, file = "../BuildData/02-008_BigSeries_NoMB09_NoMBex_Validation.CSV")
write.csv(wmadf, file = "../BuildData/02-008_BigSeries_NoMB09_NoMBex_Whole.CSV")

saveRDS(tmadf, file = "../BuildData/02-008_BigSeries_NoMB09_NoMBex_Training.rds")
saveRDS(vmadf, file = "../BuildData/02-008_BigSeries_NoMB09_NoMBex_Validation.rds")
saveRDS(wmadf, file = "../BuildData/02-008_BigSeries_NoMB09_NoMBex_Whole.rds")
