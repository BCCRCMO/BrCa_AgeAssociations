...
ptadf <- read.table(file = "../../data/Data_NormalBreast13_TMA_IHC_Trends/Patient_Ages.csv",
                    sep = ",", stringsAsFactors = FALSE, header = TRUE)
ptadf$PatientID <- ptadf$PatID
ptcdf <- read.table(file = "../../data/Data_NormalBreast13_TMA_IHC_Trends/Normal_Breast_TMA_SMmods.csv",
                    sep = ",", stringsAsFactors = FALSE, header = TRUE)
...
write.csv(nb13tmadf[order(nb13tmadf$TMABlockn,nb13tmadf$withinTMABlockID),
          ...
          file = "../../data/Data_NormalBreast13_TMA_IHC_Trends/RandomizedLat_NormalBreastTMA_NB13_v03.csv")
...
write.csv(nb13tma4df[order(nb13tma4df$TMABlockn,nb13tma4df$withinTMABlockID),
                    c("BlockID", "Age", "Ncores", "Comments", "Slide.box.number",
                      ...
                      "withinTMABlockID", "nb13_id", "TMABlockn", "DiagnosisYear", "Laterality",
                      "isUnpairedp", "isUnpaired"),],
          file = "../../data/Data_NormalBreast13_TMA_IHC_Trends/RandomizedLat4core_NormalBreastTMA_NB13_v01.csv")
