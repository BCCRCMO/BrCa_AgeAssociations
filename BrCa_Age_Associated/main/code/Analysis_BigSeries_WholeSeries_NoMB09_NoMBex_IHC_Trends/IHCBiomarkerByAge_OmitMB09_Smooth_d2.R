...
date()
date()
pdf(file = "BigSeries_TNP_WholeSeries_NoMB09_NoMBex_IHC_Trends_99p9pct_40kSimCIs_shaded_v01.pdf",
    width = 8, height = 8)
par(mfrow = c(2, 2))
set.seed(473); sapply(cscvars, simsmufit, xdf = tnmadf, nsim = 40000, alpha = 0.001)
dev.off()
date()
date()
...
date()
date()
pdf(file = "BigSeries_Luminalp_WholeSeries_NoMB09_NoMBex_IHC_Trends_99p9pct_40kSimCIs_shaded_v01.pdf",
    width = 8, height = 8)
par(mfrow = c(2, 2))
set.seed(473); sapply(cscvars, simsmufit, xdf = lpmadf, nsim = 40000, alpha = 0.001)
dev.off()
date()
date()
