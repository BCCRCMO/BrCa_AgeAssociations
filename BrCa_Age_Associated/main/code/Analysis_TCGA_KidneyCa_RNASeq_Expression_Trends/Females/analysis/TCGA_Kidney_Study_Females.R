...
tcga_process(cldf, ealldf, annodf, ardf, ezdf, ebdf, ebdf_t1, ebdf_t2, gender = "female")
...
file.name <- glue("TCGA_{organ}Ca_AgeRelated_{paste0(str_sub(sub, end = -2), 'Cases')}{nrow(sedf)}")
tcga_lm %>%
